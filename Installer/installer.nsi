...
Name "Ogrevedad"
OutFile "Ogrevedad setup.exe"
Unicode True
InstallDir "$PROGRAMFILES64\Ogrevedad"
...
Section
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\$GameName.lnk" "$INSTDIR\Ogrevedad.exe"
